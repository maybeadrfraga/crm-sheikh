        ...
        <ul class="navbar-nav">         
            ...
            <li class="nav-item p-1">
                ...
                <div class="collapse show" id="finance">
                    <ul class="nav ms-4 border-start">
                        <li class="nav-item ">
                            <a class="nav-link text-white  opacity-10 {{ is_current_route('expenses.index') ? 'active' : '' }} "
            ...
            <li class="nav-item p-1">
                ...
                <div class="collapse show" id="companies">
                    <ul class="nav ms-4 border-start">
                        <li class="nav-item ">
                            <a class="nav-link text-white  opacity-10 {{ is_current_route('companies.index') ? 'active' : '' }} "
