                ...
                <div class="col-lg-9 col-12 ">
                    <div class="card " id="basic-info">
                        ...
                        <div class="pt-0 card-body">
                            <form role="form" method="POST" action="{{ route('expenses.store') }}">
                                @csrf
                                ...
                                <div class="form-group">
                                    ...
                                    <input type="number" class="form-control" id="amount" required placeholder="Enter amount" name="amount" value="{{ old('amount') }}">
                                    @error('amount')
                                        <span class="text-danger text-sm">{{ $message }}</span>
                                    @enderror
                                </div>
